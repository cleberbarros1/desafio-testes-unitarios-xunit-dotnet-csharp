# .NET - Testes Unitários com C#- xunit ::mag:
## Desafio de projeto
Usar os conhecimentos adquiridos no módulo de Testes Unitários com C#, da trilha .NET da DIO.
...
Agradecimentos ao Professor Leonardo Buta e a toda equipe DIO pelo curso fantástico!